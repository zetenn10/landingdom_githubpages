...
//                 // elemen.className = 'card shadow-sm';
//                 elemen.innerHTML = `
...
//                                             <small class="text-muted">${anime.score}</small>
//                                             <p></p>
//                                             <small class="text-muted">${anime.status}</small>
//                                             <p></p>
//                                             <small class="text-muted">${anime.episode}</small>
//                                             <p></p>
//                                             <small class="text-muted">${anime.duration}</small>
//                                             <p></p>
//                                             <small class="text-muted">${anime.studio}</small>
//                                             <p></p>
//                                             <small class="text-muted">${anime.genres}</small>
